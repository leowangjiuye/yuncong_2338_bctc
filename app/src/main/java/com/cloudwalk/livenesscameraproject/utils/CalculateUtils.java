...
public class CalculateUtils {
	 ...
	 * @author yltang 2015-8-25 下午4:52:01
	 */
	public static String add(String para1, String para2,int count) {
		if (TextUtils.isEmpty(para1)) {
			para1 = "0.00";
		}
		if (TextUtils.isEmpty(para2)) {
		...
		BigDecimal val1 = new BigDecimal(para1);
		BigDecimal val2 = new BigDecimal(para2);
		return val1.add(val2).setScale(count, BigDecimal.ROUND_HALF_UP).toString();
	}
	 ...
	 * @author yltang 2015-8-27 上午9:57:47
	 */
	public static String subtract(String para1, String para2,int count) {
		if (TextUtils.isEmpty(para1)) {
			para1 = "0.00";
		}
		if (TextUtils.isEmpty(para2)) {
		...
		BigDecimal val1 = new BigDecimal(para1);
		BigDecimal val2 = new BigDecimal(para2);
		return val1.subtract(val2).setScale(count, BigDecimal.ROUND_HALF_UP).toString();
	}
	 ...
	 * @author yltang 2015-8-25 下午4:53:21
	 */
	public static String multiply(String para1, String para2,int count) {
		if (TextUtils.isEmpty(para1)) {
			para1 = "0.00";
		}
		if (TextUtils.isEmpty(para2)) {
		...
		BigDecimal val1 = new BigDecimal(para1);
		BigDecimal val2 = new BigDecimal(para2);
		return val1.multiply(val2).setScale(count, BigDecimal.ROUND_HALF_UP).toString();
	}
	 ...
	 * @author yltang 2015-8-25 下午5:32:14
	 */
	public static String divide(String para1, String para2,int count) {
		if (TextUtils.isEmpty(para1)) {
			para1 = "0.00";
		}
		if (TextUtils.isEmpty(para2)) {
		...
		BigDecimal val2 = new BigDecimal(para2);
		// 除法保留两位小数并且四舍五入
		return val1.divide(val2, count, BigDecimal.ROUND_HALF_UP).toString();
	}
	 ...
	 * @author yltang 2015-8-25 下午4:52:01
	 */
	public static String add(String para1, String para2,int count,RoundingMode roundingMode) {
		if (TextUtils.isEmpty(para1)) {
			para1 = "0.00";
		}
		if (TextUtils.isEmpty(para2)) {
		...
		BigDecimal val1 = new BigDecimal(para1);
		BigDecimal val2 = new BigDecimal(para2);
		return val1.add(val2).setScale(count, roundingMode).toString();
	}
