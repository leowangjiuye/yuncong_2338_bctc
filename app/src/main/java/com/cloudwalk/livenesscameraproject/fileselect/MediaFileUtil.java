package com.cloudwalk.livenesscameraproject.fileselect;
...
public class MediaFileUtil {
    ...
    public static final int FILE_TYPE_XML = 37;
    public static final int FILE_TYPE_MDL = 38;
    public static final int FILE_TYPE_DPN = 39;
    private static final int FIRST_IMAGE_FILE_TYPE = FILE_TYPE_JPEG;
    private static final int LAST_IMAGE_FILE_TYPE = FILE_TYPE_DPN;
    ...
    static {
        ...
        addFileType("XML", FILE_TYPE_XML, "image/XML");
        addFileType("MDL", FILE_TYPE_MDL, "image/MDL");
        addFileType("DPN", FILE_TYPE_DPN, "image/dpn");
